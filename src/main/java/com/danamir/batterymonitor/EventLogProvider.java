...
public class EventLogProvider extends ContentProvider {
    public static final String AUTHORITY = "com.danamir.batterymonitor.eventlog";
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        String jsonData = prefs.getString(PREF_BATTERY_LOG, "[]");
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (jsonData != null) {
            SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
            prefs.edit().putString(PREF_BATTERY_LOG, jsonData).commit();
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        prefs.edit().putString(PREF_BATTERY_LOG, "[]").commit();
